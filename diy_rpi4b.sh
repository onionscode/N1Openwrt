...
echo '修改机器名称'
sed -i 's/OpenWrt/RaspBerry4 Pi model B/g' package/base-files/files/bin/config_generate
...
echo "echo \"DISTRIB_REVISION='${version} $(TZ=UTC-8 date "+%Y.%m.%d") Compilde by O.N.I.O.N'\" >> /etc/openwrt_release" >> package/lean/default-settings/files/zzz-default-settings
